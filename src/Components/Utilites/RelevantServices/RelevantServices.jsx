  ...
  return (
    <div className='pt-5 md:pt-10'>
      <div className='text-center font-Raleway '>
          <h3 className='text-[32px] font-bold md:text-[48px]'>Relevant Services </h3>
      </div>
      <div className='grid grid-cols-1 md:grid md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4  2xl:grid-cols-4 justify-items-center place-items-center gap-8 pb-8 md:gap-16 mt-5 md:mt-10 '>
            {/* one */}
