  ...
  return (
    <div className="py-5">
      <div className="px-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-20 px-4">
            ...
            <div className="max-w-[310px] flex  items-start gap-x-3  border border-[#E2E2E2] bg-[#FDFDFD] rounded-md p-3">
                ...
                <div>
                    <h2 className="text-[#444] font-Raleway text-[18px] font-[600]">UI/UX Design</h2>
                    <p className="text-[#666] text-[14px] font-[400] ">Order No. #F06CE0914A11</p>
                </div>
                <div>
        ...
        <div className="bg-white mt-4 space-y-5 p-5 4  rounded-md">
          ...
          <div className="flex space-x-4">
            ...
            <div>
              ...
              Hi, I&apos;ve submitted the UI design project requirement, please check and let me know if you have any questions. 
              </p>
            </div>
          </div>
          {/* 2nd chatting */}
          ...
          <div className="flex space-x-4">
            ...
            <div>
              ...
              <p className="text-[14px] font-Raleway font-[400] text-[#666]">
              Nice to meet you. Yes, got the details, I’m starting work on it. Please accept the below offer to get one more concept for the UI design.
              </p>
            </div>
          </div>
          {/* 3rd chatting */}
       ...
       <div className=" border border-[#E2E2E2]   py-5 rounded-md pb-0">
          <div className="px-5 lg:px-4">
            ...
            <div>
              <p className="text-[#666666] text-[14px] pb-4">
                ...
                orci enim. Scelerisque molestie aliquam ac mauris ipsum
                venenatis egestas. Scelerisque molestie aliquam ac mauris ipsum
                venenatis egestas.{" "}
              </p>
            </div>
        ...
        <div className="border border-[#E2E2E2] rounded-md py-3 mt-4 flex space-x-4 px-3 lg:ml-4 lg:mr-20">
          ...
          <div>
            <div className="flex space-x-4">
              <h3 className="text-[14px] font-Raleway text-[#333] font-[700]">Envobyte</h3>{" "}
      ...
      <div className="border border-[#E2E2E2] rounded-md mt-4  px-3 lg:ml-4 lg:mr-20 py-5">
         {/* delivery title */}
           <div className="pb-5">
           <h3 className="text-[#333] font-Raleway text-[24px] font-[700]">Delivery #1</h3>
          <div className="border-b-2 border-[#E2E2E2] py-2">
           ...
           <div>
            ...
            <div className="space-y-2">
                <h3 className="text-[#333] font-Raleway text-[14px] font-[700]">Envobyte Message</h3>
                <p className="text-[14px] text-[#666] font-[400]">Hi Envobyte,</p>
                <p className="text-[14px] text-[#666] font-[400]">Thanks again for your work!. Your  delivery is enclosed. If there are any problems, Please let me know I will get back to you soon as I can.</p>
                 <div className="lg:pt-4">
                    <h3 className="text-[#333] font-Raleway text-[16px] font-[600]">Attachments</h3>
                 </div>
